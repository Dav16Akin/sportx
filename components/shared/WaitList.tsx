          ...
          <div ref={ref} className={`${mode === 'dark' ? 'bg-black border border-zinc-600' : 'bg-white'} w-full max-w-md mx-auto rounded-xl ${submitted ? 'p-1' : 'p-6'} z-50`}>
            {!submitted ? (
              <div>
                <div className="text-center">
                  <motion.h1
                    ...
                    className={`${mode === 'dark' ? 'text-white' : 'text-gray-800'} text-4xl font-bold mb-4`}
                  >
                  ...
                  >
                    Be the first to access new drops. Enter your email below to join the waitlist.
                  </motion.p>
                </div>
                <motion.form
                  initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                >
                  Thank you for using SportX.<br /> We&apos;ll keep you updated.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, scale: 0.5 }}
                  animate={{ opacity: 1, scale: 1 }}
